...
<body id="body">
<section>
<font face="arial" size="5" color="#DF7401"><b>Performance Trigger - network: server</b></font>
...
<label>Search for VMID or IP </label><br>
<input placeholder="Linux VMID here" type="text" name="system" id="vmid" class="">
</div>
</div>
<div class="">
...
$sql1 = sprintf("select * from VLANDATA where VMID='%s' OR IP='%s'", $systemout, $systemout);
...
<table id="usage">
          <thead>
        <tr>
<th><span>LPAR</span></th>
<th><span>VSWITCH</span></th>
<th><span>VLAN</span></th>
<th><span>Subnet</span></th>
<th><span>VMID</span></th>
<th><span>IP</span></th>
