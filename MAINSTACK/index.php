...
<br>
    ...
    <!--<table id="example" class="display" style="width:100%" style="font-size:13px"> -->	
            ...
            <tr>
                        ...
                        <th align=left>Server or VMID</th>
	    ...
	    <tr style="display: none">	    
			<td align=left><?php echo $dado[$VCS]; ?></td>
			<!-- POPUP BOX -->
		...
		<?php
		//$count_item = mysqli_num_rows($con);
	
		?>
			

		<!--<h4>Search Results: <?php //echo $count_item; ?> </h4>-->
<br>
<br><br><br>
...
<button class="accordion">6-CRITICAL APPS</button>
	<div class="panel">
...
<p class="w3-center"><em>Application developed by <b>Garage101: rgaiotto@br.ibm.com, anafs@br.ibm.com</b></em></p>

 <center><a href="#"><img width="15%" alt="Powered by Garage101" src="dino.jpg"></center><br>
