...
<table id="myTable">	    
    ...
    <tbody>
    <tr>
    <td align=left><?php echo $row['SSCDQ']; ?></td>
    </tr> 	    
    </tbody>
<?php } ?>	
</table> <br>
