...
$sql=sprintf("SELECT DISTINCT IM1,FLL,SLL,SSCDQ FROM main WHERE SSCDQ IN (".implode(',', array_map('add_quotes',$lines)).")");		
...
<table id="demo1" cellpadding="0" cellspacing="0" style="width:100%" style="font-size:13px">
            ...
            <tbody>
            <tr>
	    		<td align=left style="font-size:14px"><?php echo $dado[$SSCDQ]; ?></td>
